...
using Unity.Jobs;
using UnityEngine;
public class FractalWithJob : MonoBehaviour
{
    ...
    {
        _parts = new NativeArray<FractalPart>[_depth];// new FractalPart[_depth][];
        _matrices = new NativeArray<Matrix4x4>[_depth];//new Matrix4x4[_depth][];
